                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h1 class="mb-3">This is a Heading 1</h1>
                                        <h2 class="mb-3">This is a Heading 2</h2>
                                        <h3 class="mb-3">This is a Heading 3</h3>
                                        <h4 class="mb-3">This is a Heading 4</h4>
                                        <h5 class="mb-3">This is a Heading 5</h5>
                                        <h6 class="mb-3">This is a Heading 6</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
