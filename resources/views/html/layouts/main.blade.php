<body class="{{$bodyclass}}">
	...
	<nav class="pcoded-navbar {{$menuclass}} @if($layouts=='horizontal') theme-horizontal @endif">
		<div class="navbar-wrapper @if($sublayouts=='v2') container @endif">
			...
			<div class="navbar-content @if($layouts=='vertical') scroll-div @endif @if($layouts=='horizontal') sidenav-horizontal @endif" @if($layouts=='horizontal' )id="layout-sidenav" @endif>
				@if($sublayouts=='layout-1')
				<div class="@if($sublayouts=='layout-1') layout1-nav @endif">
					@include('html.layouts.menu-tab-list')
				</div>
				@endif
				@if($sublayouts!='layout-1')
					<ul class="nav pcoded-inner-navbar @if($layouts=='horizontal') sidenav-inner @endif">
	...
	<header class="navbar pcoded-header navbar-expand-lg navbar-light {{$headerclass}}">
		@if($sublayouts=='v2')<div class="container">@endif
			<div class="m-header">
	...
	<!-- [ Header ] end -->
	@if($sublayouts=='v2' || $sublayouts=='v1')
	<script class="h2temp">
		setTimeout(function() {
			document.getElementsByClassName("pcoded-wrapper")[0].classList.add("container");
